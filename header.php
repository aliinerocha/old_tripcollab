...
<head>
  ...
  <link rel="stylesheet" href="../assets/css/header.css" class="sty">
...
<body>
  <header class="navbar navbar-expand-lg navbar-light bg-blue">
    <div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="material-icons align-text-bottom">language</i> PT-BR
          </a>
          <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <a class="dropdown-item" href="#">PT-BR</a>
            <a class="dropdown-item" href="#">EN-EUA</a>
          </div>
        </li>
      </ul>
    </div>
